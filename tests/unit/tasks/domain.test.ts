import { DomainTask } from '../../../src/core/tasks/domain.js';
import { UpsunClient } from '../../../src/upsun.js';
import { DomainManagementApi } from '../../../src/apis-gen/index.js';
...
describe('DomainTask', () => {
  ...
  beforeEach(() => {
    ...
    (DomainManagementApi as jest.MockedClass<typeof DomainManagementApi>).mockImplementation(() => mockDomainApi);
    ...
    domainTask = new DomainTask(mockClient);
  });
  ...
  describe('add', () => {
    it('should have add method defined', () => {
      expect(domainTask.add).toBeDefined();
      expect(typeof domainTask.add).toBe('function');
    });
    ...
    it('should add a domain to project', async () => {
      ...
      const result = await domainTask.add('project-123', 'example.com');
    ...
    it('should add a domain to environment', async () => {
      ...
      const result = await domainTask.add('project-123', 'example.com', 'env-456');
      expect(result).toBeDefined();
    ...
    it('should handle domain addition errors', async () => {
      ...
      await expect(domainTask.add('project-123', 'example.com')).rejects.toThrow('Domain already exists');
    });
  });

  describe('delete', () => {
    it('should have delete method defined', () => {
      expect(domainTask.delete).toBeDefined();
      expect(typeof domainTask.delete).toBe('function');
    });
    ...
    it('should delete a domain from project', async () => {
      ...
      const result = await domainTask.delete('project-123', 'domain-456');
      expect(result).toBeDefined();
    ...
    it('should delete a domain from environment', async () => {
      ...
      const result = await domainTask.delete('project-123', 'domain-456', 'env-789');
      expect(result).toBeDefined();
    ...
    it('should handle domain deletion errors', async () => {
      ...
      await expect(domainTask.delete('project-123', 'domain-456')).rejects.toThrow('Domain not found');
    });
  });

  describe('get', () => {
    it('should have get method defined', () => {
      expect(domainTask.get).toBeDefined();
      expect(typeof domainTask.get).toBe('function');
    });
    ...
    it('should get domain information', async () => {
      ...
      const result = await domainTask.get('project-123', 'domain-456');
      expect(result).toBeDefined();
    ...
    it('should get environment domain information', async () => {
      ...
      const result = await domainTask.get('project-123', 'domain-456', 'env-789');
      expect(result).toBeDefined();
      expect((result as any).name).toBe('example.com');
  ...
  describe('list', () => {
    it('should have list method defined', () => {
      expect(domainTask.list).toBeDefined();
      expect(typeof domainTask.list).toBe('function');
    });
    ...
    it('should list project domains', async () => {
      ...
      const result = await domainTask.list('project-123');
      expect(result).toBeDefined();
    ...
    it('should list environment domains', async () => {
      const mockDomains = [
        { name: 'env-example.com', ssl: { has_certificate: true } }
      ];

      mockDomainApi.listProjectsEnvironmentsDomains.mockResolvedValue(mockDomains as any);

      const result = await domainTask.list('project-123', 'env-456');
      expect(result).toBeDefined();
  ...
  describe('update', () => {
    it('should have update method defined', () => {
      expect(domainTask.update).toBeDefined();
      expect(typeof domainTask.update).toBe('function');
    });

    it('should throw "Method not implemented" error', async () => {
      await expect(domainTask.update('project-123', 'example.com')).rejects.toThrow('Method not implemented.');
    });
  });
});
