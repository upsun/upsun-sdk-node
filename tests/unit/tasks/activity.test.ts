...
import { ProjectActivityApi, EnvironmentActivityApi } from '../../../src/apis-gen/index.js';
...
describe('ActivityTask', () => {
  ...
  beforeEach(() => {
    ...
    (ProjectActivityApi as jest.MockedClass<typeof ProjectActivityApi>).mockImplementation(() => mockProjectActivityApi);
    (EnvironmentActivityApi as jest.MockedClass<typeof EnvironmentActivityApi>).mockImplementation(() => mockEnvironmentActivityApi);
  ...
  describe('log', () => {
    it('should throw not implemented error', async () => {
      await expect(activityTask.log('project-123', 'activity-123')).rejects.toThrow('Not implemented');
    });
  });
});
